...
pub(crate) fn list(json: bool) -> xmtp::Result<()> {
...
pub(crate) fn remove(name: &str) -> xmtp::Result<()> {
...
pub(crate) fn clear() -> xmtp::Result<()> {
    let base = config::data_dir();
    if !base.exists() {
...
pub(crate) fn default(name: Option<&str>, json: bool) -> xmtp::Result<()> {
